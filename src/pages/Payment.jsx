...
const Payment = () => {
  ...
  const handlePagar = () => {
    ...
    if (!/^[A-Z][a-z]*$/.test(nombre)) {
      setNombreError('Nombre inválido. La primera letra debe estar en mayúscula.');
      return;
    }

    if (!/^[A-Z][a-z]*$/.test(apellidos)) {
      setApellidosError('Apellidos inválidos. La primera letra de cada apellido debe estar en mayúscula.');
      return;
    }
      ...
      <form className='form-payment'>
        <div className='form-group'>
          ...
          <label className='label-field'>
            ...
            <span className='error-message'>{apellidosError}</span>
          </label>
        </div>
